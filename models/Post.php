...
class Post extends Conexao {
  ...
  public function listarPosts(){
    $db = parent::criarConexao();
    //Usando Inner Join para pegar o nome de usuário de quem postou;
    ...
    $resultado = $query->fetchAll(PDO::FETCH_OBJ); //traduzindo tudo que recebe para um formato que o php entenda. Nesse caso, optei receber objeto.
    return $resultado;
  } 
