...
class Post extends Conexao {
  ...
  public function criarPost($image,$description){
    //Armazenando a conexão na variável $db:
    $db = parent::criarConexao();
    $query = $db->prepare("INSERT INTO posts (image,description) VALUES (?,?)");
    return $query->execute([$image,$description]); //retorna true or false. Manda pro controller analisar
  }
